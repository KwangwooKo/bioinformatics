...
###############################################################################
# By Bioinformagican (https://github.com/kpatel427/YouTubeTutorials/blob/main/singleCell_standard_workflow.R)
...
# common QC metrics 
# 1. low no. genes, 2. very high no. genes, 3. high % mitochondrial genes
...
#cf. nCount_RNA: total number of molecules detected
#cf. nFeature_RNA: total number of genes detected

VlnPlot(nsclc.seurat.obj, features = c("nFeature_RNA", 
                                       "nCount_RNA", 
                                       "percent.mt"), ncol = 3)
...
# 4. Identify highly variable features (cell to cell) --------------
...
# 5. Scaling (this is the process of adjusting library size) -------------
...
DimPlot(nsclc.seurat.obj, reduction = "pca") + NoLegend()
