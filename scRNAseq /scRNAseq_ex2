(Reference: lecture 13 &14) https://diytranscriptomics.com/
Refer to lecture note
Kallisto is used for the alignment


# Introduction ----
# this script walks through the quality assessment (QA) and 
## analysis of single cell RNA-seq data
# In the 1st 1/2 of the script, we'll practice some basics using a small 
## (~1000 cell) dataset from human peripheral blood mononuclear cells (PBMCs). 
### This dataset comes from the public datasets on the 10X Genomics website: 
#### https://www.10xgenomics.com/resources/datasets
# In the 2nd 1/2 of the script, we'll import two separate Seurat objects 
## generated from the spleen of naive and Toxoplasma gondii infected mice, 
### giving us an opportunity to create and analyze an integrated dataset

# Import data into R and filter out empty drops ----
# Begin by setting up a new RProject in the folder where you just processed 
## your scRNA-seq data with Kb
# a huge, powerful, and popular library for analyzing single cell genomic data

library(tidyverse)
library(DropletUtils)

# I noticed that library(DropletUtils) did not work.
...
# load barcodes
barcodes <- read.csv('counts_unfiltered/cellranger/barcodes.tsv', sep = '\t', header = F)
